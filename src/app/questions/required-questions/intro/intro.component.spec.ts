...
import { QuestionsRequiredQuestionsIntroComponent } from './intro.component';
...
describe('QuestionsRequiredQuestionsIntroComponent', () => {
  let component: QuestionsRequiredQuestionsIntroComponent;
  let fixture: ComponentFixture<QuestionsRequiredQuestionsIntroComponent>;
  let activatedRoute;
  let router;
  let store;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(QuestionsRequiredQuestionsIntroComponent);
