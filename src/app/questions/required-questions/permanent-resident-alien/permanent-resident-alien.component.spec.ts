...
import { QuestionsRequiredQuestionsPermanentResidentAlienComponent } from './permanent-resident-alien.component';
import {
...
describe('QuestionsRequiredQuestionsPermanentResidentAlienComponent', () => {
  let component: QuestionsRequiredQuestionsPermanentResidentAlienComponent;
  let fixture: ComponentFixture<QuestionsRequiredQuestionsPermanentResidentAlienComponent>;
  let activatedRoute;
  let router;
  let store;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(QuestionsRequiredQuestionsPermanentResidentAlienComponent);
  ...
  describe('the component form', () => {
    it('should have the permanentResidentAlien control with no default value', () => {
      expect(component.form.controls['permanentResidentAlien']).toBeDefined();
      expect(component.form.controls['permanentResidentAlien'].value).toEqual(null);
    });

    it('should require the permanentResidentAlien control', () => {
      component.form.controls['permanentResidentAlien'].setValue(null);
      expect(component.form.valid).toBeFalsy();

      component.form.controls['permanentResidentAlien'].setValue('permanentResidentAlien');
      expect(component.form.valid).toBeTruthy();
    });

    describe('with previous data in the store', () => {
      it('should set the value of the control to "yes" if the store is true OnInit', () => {
        store.dispatch(new GovernmentQuestionsPermanentResidentAlienUpdateAction(true));
        component.ngOnInit();
        expect(component.form.controls['permanentResidentAlien'].value).toEqual('yes');
      });

      it('should set the value of the control to "no" if the store is false OnInit', () => {
        store.dispatch(new GovernmentQuestionsPermanentResidentAlienUpdateAction(false));
        component.ngOnInit();
        expect(component.form.controls['permanentResidentAlien'].value).toEqual('no');
      });
  ...
  describe('setting up onSubmitMethod', () => {
    beforeEach(() => {
      component.form = ({
        valid: true,
        value: {
          permanentResidentAlien: 'yes'
        }
      } as FormGroup);
      component.onSubmit();
    });

    it('should dispatch an event to update the store sending in a true when permanentResidentAlien is yes', () => {
      expect(store.dispatch).toHaveBeenCalledWith(new GovernmentQuestionsPermanentResidentAlienUpdateAction(
        true
      ));
    });

    it('should dispatch an event to update the store sending in a false when permanentResidentAlien is no', () => {
      store.dispatch.calls.reset();
      component.form = ({
        valid: true,
        value: {
          permanentResidentAlien: 'no'
        }
      } as FormGroup);
      component.onSubmit();
      expect(store.dispatch).toHaveBeenCalledWith(new GovernmentQuestionsPermanentResidentAlienUpdateAction(
  ...
  describe('HTML integration tests', () => {
    it('should map the #yes input to the permanentResidentAlien control', () => {
    ...
    it('should map the #no input to the permanentResidentAlien control', () => {
