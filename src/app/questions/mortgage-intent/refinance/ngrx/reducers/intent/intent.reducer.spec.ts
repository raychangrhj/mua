import * as reducer from './intent.reducer';
import { IntentUpdateAction } from '../../actions/intent/intent.action';
...
describe('Intent Reducer', () => {
  ...
  describe('reducer function', () => {
    it('should return the payload of a UPDATE action', () => {
      ...
      const result = reducer.reducer(null, new IntentUpdateAction(payload));
    ...
    it('should not mutate the existing state', () => {
      ...
      const payload = '2012-02-02';
      const result = reducer.reducer(initState, new IntentUpdateAction(payload));
