import * as reducer from './loan-amount.reducer';
import { LoanAmountUpdateAction } from '../../actions/loan-amount/loan-amount.action';
import { Test } from '../../../../../../../test/test.action';

describe('Loan Amount Reducer', () => {
  ...
  describe('reducer function', () => {
    it('should return the payload of a UPDATE action', () => {
      const payload = 10000;
      const result = reducer.reducer(null, new LoanAmountUpdateAction(payload));
    ...
    it('should not mutate the existing state', () => {
      ...
      const payload = 10000;
      const result = reducer.reducer(initState, new LoanAmountUpdateAction(payload));
